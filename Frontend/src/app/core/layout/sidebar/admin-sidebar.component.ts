...
export class AdminSidebarComponent {
  ...
  protected readonly navItems: Array<{
    ...
    { label: 'Perfil del Taller', path: '/admin/workshop/profile', exact: true },
    { label: 'Catálogo de Servicios', path: '/admin/workshop/catalog', exact: true },
    { label: 'Personal Técnico', path: '/admin/workshop/staff', exact: true },
    { label: 'Repuestos', path: '/admin/workshop/spare-parts', exact: true },
    { label: 'Solicitudes', path: '/admin/requests' },
    { label: 'Asignaciones', path: '/admin/services/waiting-assignment' },
    { label: 'Tracking en vivo', path: '/admin/services/tracking', exact: true },
    { label: 'Citas de mantenimiento', path: '/admin/maintenance-appointments', exact: true },
